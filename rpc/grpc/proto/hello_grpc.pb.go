...
func (c *helloServiceClient) Channel(ctx context.Context, opts ...grpc.CallOption) (HelloService_ChannelClient, error) {
	stream, err := c.cc.NewStream(ctx, &HelloService_ServiceDesc.Streams[0], "/proto.HelloService/Channel", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *pubsubServiceClient) Subscribe(ctx context.Context, in *String, opts ...grpc.CallOption) (PubsubService_SubscribeClient, error) {
	stream, err := c.cc.NewStream(ctx, &PubsubService_ServiceDesc.Streams[0], "/proto.PubsubService/Subscribe", opts...)
	if err != nil {
		return nil, err
	}
...
type RestServiceClient interface {
	...
	Post(ctx context.Context, in *String, opts ...grpc.CallOption) (*String, error)
}
...
func (c *restServiceClient) Get(ctx context.Context, in *String, opts ...grpc.CallOption) (*String, error) {
	out := new(String)
...
func (c *restServiceClient) Post(ctx context.Context, in *String, opts ...grpc.CallOption) (*String, error) {
	out := new(String)
...
func (UnimplementedRestServiceServer) Get(context.Context, *String) (*String, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Get not implemented")
}
func (UnimplementedRestServiceServer) Post(context.Context, *String) (*String, error) {
...
func _RestService_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RestServiceServer).Get(ctx, req.(*String))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _RestService_Post_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RestServiceServer).Post(ctx, req.(*String))
	}
	return interceptor(ctx, in, info, handler)
}
